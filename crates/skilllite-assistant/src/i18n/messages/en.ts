...
export const enMessages: Record<string, string> = {
  ...
  "settings.environment.intro":
    "Runtimes are Python and Node for sandboxed scripts. Git is required only when installing skills from a Git URL via `skilllite add`. ClawHub or local folders do not need Git.",
  ...
  "settings.environment.gitDesc": "`skilllite add <repo>` expects `git` on your PATH.",
